...
def sampleArmy():
    ...
    templ2 = SquadTemplate.SquadTemplate(name=u'Battle Pony', mobility=mount,  type=[armor], raise_cost=5, supply=5, weight=5, tl=4, ts=5)
    templ3 = SquadTemplate.SquadTemplate(name=u'Fly Pony', mobility=mechanized, type=[air, naval], raise_cost=5, supply=5, weight=5, tl=3, ts=5)
    templ4 = SquadTemplate.SquadTemplate(name=u'Pony1', mobility=foot, type=[naval, Fire], raise_cost=5, supply=5, weight=5, tl=5, ts=5)
    templ5 = SquadTemplate.SquadTemplate(name=u'Pony2', mobility=mount,  type=[armor], raise_cost=5, supply=5, weight=5, tl=4, ts=5)
    templ6 = SquadTemplate.SquadTemplate(name=u'Pony13', mobility=mechanized, type=[air, naval], raise_cost=5, supply=5, weight=5, tl=3, ts=5)
